package br.com.lio.contatos.testeI;

import br.com.lio.contatos.controller.dto.ContatoRequest;
import br.com.lio.contatos.repository.ContatoRepository;
...
class TestIntegrationContatos {
    ...
    void shouldAddContactReturnValidationExceptionIfRepeatedEmail() {
        ContatoRequest contatoTest = new ContatoRequest(retornaNomeAleatorio(),"liocroons@prova.com", retornaTelefoneAleatorio());
